...
class StockChart extends Component {
  ...
  componentDidMount(){
    ...
    let inputs = chart.rangeSelector.inputGroup.element.children;
    this.setState({
      to: inputs[1].textContent,
      from: inputs[3].textContent,
    });
...
//use recharts instead http://recharts.org/#/en-US/guide/getting-started
